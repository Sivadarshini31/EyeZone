    ...
    <main className="flex-grow flex items-center justify-center p-4">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
        <input
          ...
          className="hidden"
        />
        <IconButton label={t.gallery} onClick={() => galleryInputRef.current?.click()} icon={
        ...
        <input
          ...
          className="hidden"
        />
        <IconButton label={t.camera} onClick={() => cameraInputRef.current?.click()} icon={
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-full h-full">
        ...
        <input
          ...
          className="hidden"
        />
        <IconButton label={t.pdf} onClick={() => pdfInputRef.current?.click()} icon={
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-full h-full">
